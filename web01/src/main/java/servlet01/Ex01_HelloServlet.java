...
//@WebServlet("/hello") //매핑 네임
//@WebServlet(urlPatterns = {"/hello","/안녕","/IMG","/123","/7seven","/seven7"})
...
public class Ex01_HelloServlet extends HttpServlet {
    ...
    // throws 의 경우 예외처리를 위임시킴
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
//		response.getWriter().append("Served at: ").append(request.getContextPath()).append("여기는 Get 메서드입니다.");
		...
		out.print("<html><body>");
		out.print("<h2 style = 'color:red;'> **Hello Servlet Get**</h2>");
...
//		response.getWriter().append("Served at: ").append(request.getContextPath()).append("여기는 Post 메서드입니다.");
		
		PrintWriter out = response.getWriter();
		out.print("<html><body>");
		out.print("<h2 style = 'color:blue;'> **Hello Servlet Post **</h2>");
		out.print("<h3> => ContextPath : " + request.getContextPath() + "</h3>");
		out.print("<h3> => 여기는 Post 입니다. </h3>");
		out.print("</body></html>");
	} //doPost - doGet 호출
