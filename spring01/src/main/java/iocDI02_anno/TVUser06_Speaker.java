...
//@Component
class Speaker {
	public Speaker() { System.out.println("~~ Speaker Default 생성자 ~~"); } //생성자
...
class SsTVs implements TV {
	...
	public SsTVs() { System.out.println("~~ SsTVs Default 생성자 ~~"); } //생성자
...
//    -> 없으면 @Autowired 구문에서 오류 : UnsatisfiedDependencyException: Error creating bean with....
...
class LgTVs implements TV {
	...
	public LgTVs() { System.out.println("~~ LgTVs Default 생성자 ~~"); } //생성자
...
class AiTVs implements TV {
	...
	public AiTVs() { System.out.println("~~ AiTVs Default 생성자 ~~"); } //생성자
