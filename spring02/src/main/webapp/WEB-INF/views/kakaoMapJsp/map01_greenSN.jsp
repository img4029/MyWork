...
=> Javascript 키 : 4eb452652cd58d1487ceca0e8cb1bbc9 (적용)

=> http://apis.map.kakao.com/web/sample/ 
=> 객체및 사용법 안내 : https://apis.map.kakao.com/web/documentation/
-->	
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=4eb452652cd58d1487ceca0e8cb1bbc9&libraries=services">
</script>	
...
var address = '경기 이천시 부발읍 대산로 759' ;
var description = '임명건의 집' ; // description: 설명,묘사
